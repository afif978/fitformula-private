  ...
  const renderDashboard = () => (
    <div className="space-y-6">
      ...
      <div className="text-center">
        ...
        <p className="text-gray-300 mt-2">Track, achieve, and celebrate your progress</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <Card className="bg-blue-600 border-blue-500 hover:shadow-lg transition-shadow text-white">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium text-blue-100">Calories Remaining</CardTitle>
        ...
        <Card className="bg-blue-600 border-blue-500 hover:shadow-lg transition-shadow text-white">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium text-blue-100">Exercise Today</CardTitle>
            <Activity className="h-4 w-4 text-blue-200" />
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold text-white">{userStats.exerciseCaloriesBurned}</div>
            <p className="text-xs text-blue-200">calories burned</p>
        ...
        <Card className="bg-blue-600 border-blue-500 hover:shadow-lg transition-shadow text-white">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium text-blue-100">Weight Progress</CardTitle>
            <Target className="h-4 w-4 text-blue-200" />
          </CardHeader>
          <CardContent>
        ...
        <CardContent>
          <div className="space-y-4">
            <div className="flex justify-between items-center">
              ...
              <Badge variant="outline" className="border-gray-600 text-gray-300">420 cal</Badge>
            </div>
            <div className="flex justify-between items-center">
              <span className="text-gray-300">Lunch</span>
              <Badge variant="outline" className="border-gray-600 text-gray-300">650 cal</Badge>
            </div>
            <div className="flex justify-between items-center">
              <span className="text-gray-300">Dinner</span>
              <Badge variant="outline" className="border-gray-600 text-gray-300">380 cal</Badge>
            </div>
      ...
      <div className="container mx-auto px-4 py-8">
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          <TabsList className="grid w-full grid-cols-6 mb-8 bg-gray-700 border-gray-600">
            <TabsTrigger value="dashboard" className="text-gray-300 data-[state=active]:bg-blue-600 data-[state=active]:text-white">Dashboard</TabsTrigger>
            <TabsTrigger value="food" className="text-gray-300 data-[state=active]:bg-blue-600 data-[state=active]:text-white">Food Diary</TabsTrigger>
            <TabsTrigger value="exercise" className="text-gray-300 data-[state=active]:bg-blue-600 data-[state=active]:text-white">Exercise</TabsTrigger>
            <TabsTrigger value="workouts" className="text-gray-300 data-[state=active]:bg-blue-600 data-[state=active]:text-white">Workouts</TabsTrigger>
            <TabsTrigger value="friends" className="text-gray-300 data-[state=active]:bg-blue-600 data-[state=active]:text-white">Friends</TabsTrigger>
            <TabsTrigger value="profile" className="text-gray-300 data-[state=active]:bg-blue-600 data-[state=active]:text-white">Profile</TabsTrigger>
          </TabsList>
